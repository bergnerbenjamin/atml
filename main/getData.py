...
def get_cross_validation_file_indices(cross_validation_runs, silent=False):
...
def get_training_eval_set(training_eval_index, silent=False):
    """
    ...
    instances_eval = get_instances_from_csv(DATAPATH, "all", False, silent=silent)
